...
public class EmailSendUtils {
  ...
  public String getCustomerWelcomeHTML(String emailAuthKey, String mappingPath){
    ...
    return "<!DOCTYPE html>\n"
        ...
        +"/users/"
        + UserRole.ROLE_CUSTOMER.asString()
        +"email-auth?authKey="
        + emailAuthKey
        +"mapping-path?="
        + mappingPath
  ...
  public String getSellerWelcomeHTML(String emailAuthKey) {
    return "<!DOCTYPE html>\n"
        + "<html lang=\"ko\">\n"
        + "<head>\n"
        + "  <meta charset=\"UTF-8\">\n"
